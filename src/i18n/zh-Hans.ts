export const i18n = {
  ...
  quarry: '砖头产量', // brick production
  magic: '宝石产量', // gem production
  dungeon: '怪物产量', // recruit production
  ...
  GAMEHELP: `每个旅店玩牌的胜利条件各不相同。反正就是要把自己的城堡造好，摧毁对方的城堡，或者赶在对手之前收集到足够的资源。
...
红色的“采石场”生产砖头，蓝色的“魔法阵”生产宝石，绿色的“地下城”生产怪物。`,
  ...
  'ArcoMage HD': '魔幻牌HD',
  DESC:
    "Web浏览器版本的3DO/NWC2000年卡牌游戏魔幻牌的开源高清克隆",
}
